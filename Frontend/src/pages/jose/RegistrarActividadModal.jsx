...
function RegistrarActividadModal() {
  ...
  const handleSave = () => {
    ...
    axiosClient.post('http://localhost:3000/actividades/actividades', {
        ...
        <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
          ...
          <div className="inline-block align-middle bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              ...
              <form className="mt-2">
                    <div>
                      <label htmlFor="nombreActividad" className="block text-sm font-medium text-gray-700">Nombre de la Actividad</label>
                    ...
                    <div className="mt-2">
                      <label htmlFor="lugarActividad" className="block text-sm font-medium text-gray-700">Lugar de la Actividad</label>
