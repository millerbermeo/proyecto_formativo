...
function EliminarElemento({ id_actividad }) {
    ...
    const handleSave = () => {
        ...
        axiosClient.delete(`http://localhost:3000/elemento/eliminar/${id_actividad}`)
            .then(response => {
    ...
    return (
        <>
            <button onClick={openModal} className="bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-5">
                eliminar
            </button>
            ...
            <div className="fixed z-10 inset-0 overflow-y-auto" style={{ display: isOpen ? 'block' : 'none' }}>
                <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div className="inline-block align-middle bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                        <h2>Desea elimnar el elemento</h2>
